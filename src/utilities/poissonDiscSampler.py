#%% Program to create a random grid of points
# NOT MY OWN WORK
...
class PoissonDisc():
    ...
    def __init__(self, width=10, height=10, r=1, k=30):
    ...
    def sample(self):
        ...
        pt = [np.random.uniform(0, self.width), #self.width
              np.random.uniform(0, self.height)] #self.height
...
# co_ords, avNearestNeighbour = poisson2dRandomPoints(no_grids,width,height,r_feasible,k=30)

# import json

# with open("15_15_15_5_30_Coords.json", 'w') as f:
#     # indent=2 is not needed but makes the file human-readable 
#     # if the data is nested
#     json.dump(co_ords, f, indent=2) 

# with open("15_15_15_5_30_CoordsAvNearest.json", 'w') as f:
#     # indent=2 is not needed but makes the file human-readable 
#     # if the data is nested
#     json.dump(co_ords, f, indent=2) 