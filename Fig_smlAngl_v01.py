#% A figure to show the effect of the small angle approximation on the accuracy of the wake velocity.
#copied (but updated and checked) from 
#C:\Users\Work\OneDrive - Durham University\4th Year Engineering\ENGI4093 Final Year Project\Python and Writing\small_angle_error_V02.py
